...
class BasketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create basket" do
    assert_difference('Basket.count') do
      post baskets_url, params: { basket: { count: @basket.count, menu_price: @basket.menu_price } }
    end
  ...
  test "should update basket" do
    patch basket_url(@basket), params: { basket: { count: @basket.count, menu_price: @basket.menu_price } }
